...
'''
3 fully-connected layers for generator
Reduced generator layer width to 600
'''
import train
...
def generator(z, y):
    ...
    net = layers.fully_connected(net, 600, activation_fn=tf.nn.sigmoid, scope='fc1')
    net = layers.fully_connected(net, 600, activation_fn=tf.nn.sigmoid, scope='fc2')
