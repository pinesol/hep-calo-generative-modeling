...
- paper recommended small minibatch size (16)
- Gen width 1200
- Layers 4
- Gen activation ReLU
...
def generator(z, y):
    ...
    net = layers.fully_connected(net, 1200, activation_fn=tf.nn.relu, scope='fc3')
    net = layers.fully_connected(net, 1200, activation_fn=tf.nn.relu, scope='fc4')
    net = layers.fully_connected(net, WIDTH*WIDTH, activation_fn=tf.nn.relu, scope='fc5')
    return net
...
class DefaultConfig(object):
    batch_size = 16 #Small so that compare_to_minibatch works
